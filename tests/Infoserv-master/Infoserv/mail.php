...
function mailA($prenom,$nom,$mail,$mdp){
		...
		<h1 style=\"text-align:center;color:#FDD835;\">Bienvenue dans la super-élite !</h1>
		<div style=\"text-align:center;padding-bottom:25px;\">
		<p style=\"color:#000000;\">Voici les informations que vous nous avez communiquées nous espérons vous revoir bientôt au sein de notre système galactique ! </p>
